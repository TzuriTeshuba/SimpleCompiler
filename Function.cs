    ...
    public class Function : JackProgramElement
    {
        ...
        public override void Parse(TokensStack sTokens)
        {
            ...
            while (sTokens.Count > 0 && !(sTokens.Peek() is Parentheses) )//)
            {
                ...
                {
                    t = sTokens.Pop();
                    if(((Separator)t).Name != ',') throw new SyntaxErrorException(@"Expected , (comma), received " + t,t);
                }
            }
            ...
            if (Body.Count == 0) throw new SyntaxErrorException("function has no statements", sTokens.LastPop);
